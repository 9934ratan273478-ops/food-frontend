...
const Food = () => {
  ...
  const getAllData = async () => {
    try {
      const response = await axios.get("https://food-backend-43tn.onrender.com/api/food/get-all-food")
  ...
  const HandelDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://food-backend-43tn.onrender.com/api/food/delete/${id}`, {
